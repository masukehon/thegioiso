<div class="col-sm-9 content category-product">
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Sửa video slider</h3>
        </div>
            ...
            <div class="col-sm-12" style="margin-top: 10px">
                ...
                <form class="form-horizontal" action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="title" class="form-control" placeholder="Nhập tiêu đề" value="<?php echo $oldSlider->name; ?>">
                    ...
                    <div class="form-group">
                        ...
                        Example: https://www.youtube.com/watch?v=7spBkzzFUto chỉ nhập dãy chữ và số ở sau cùng là: <b>7spBkzzFUto</b>
                            <input type="text" name="video" class="form-control" placeholder="" value="<?php echo $oldSlider->video; ?>">
                            <div class="error-form">
                                <?php
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-6 checkbox">
                            <input type="checkbox" <?php if($oldSlider->is_show) echo 'checked';?> name="is_show"> Hiển thị.
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-6">
                            <button type="submit" class="btn btn-success btn-block">
                                <b class="fa fa-plus-circle"></b> Sửa
                            </button>
                        </div>
                    </div>
