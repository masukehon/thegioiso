		...
		<div class="panel-body">
			<div class="col-sm-12" style="margin-top: 10px">
				...
				<div class="col-sm-9 create-category-product">
					<form class="form-horizontal" action="" method="POST" >
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên danh mục" value="<?php echo $category->name ?>">
				...
				<div class="col-sm-3 text-right">
					<a href="<?php echo admin_url('danhmucsanpham') ?>" class="btn btn-info btn-lg">
